...
/// Forwards messages between the CLI and the gateway pipeline.
/// </summary>
public sealed class CliGatewayClient : IAsyncDisposable
{
    private readonly HubConnection _connection;
    private readonly ILogger<CliGatewayClient> _logger;
    ...
    public CliGatewayClient(string gatewayUrl, string? secret, ILogger<CliGatewayClient> logger)
    {
        _logger = logger;
