...
/// Forwards messages between Discord and the gateway pipeline.
/// </summary>
public class DiscordGatewayClient : IAsyncDisposable
{
    ...
    public DiscordGatewayClient(string gatewayUrl, string? secret, ILogger<DiscordGatewayClient> logger)
    {
        _logger = logger;
        ...
        // Register handlers for gateway responses
